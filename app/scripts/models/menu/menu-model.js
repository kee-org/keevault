...
const MenuModel = Backbone.Model.extend({
    ...
    initialize: function() {
        ...
        this.shortcutsSection = new MenuSectionModel([{ locTitle: 'shortcuts', icon: 'keyboard', page: 'shortcuts' }]);
        this.aboutSection = new MenuSectionModel([{ locTitle: 'menuSetAbout', icon: 'info-circle', page: 'about' }]);
        this.helpSection = new MenuSectionModel([{ locTitle: 'help', icon: 'question', page: 'help' }]);
        this.accountSection = new MenuSectionModel([{ locTitle: 'keeAccount', icon: 'user', page: 'account' }]);
