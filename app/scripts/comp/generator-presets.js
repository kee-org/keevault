...
const GeneratorPresets = {
    get defaultPreset() {
        return { name: 'High', title: Locale.genPresetHigh,
            length: 26, upper: true, lower: true, digits: true, special: true };
    },

    get builtIn() {
        return [
            { name: 'Pronounceable', title: Locale.genPresetPronounceable,
                length: 14, lower: true, upper: true },
            { name: 'Med', title: Locale.genPresetMed,
                length: 15, upper: true, lower: true, digits: true, special: true },
            this.defaultPreset,
            { name: 'VeryHigh', title: Locale.genPresetVeryHigh,
                length: 48, upper: true, lower: true, digits: true, special: true },
