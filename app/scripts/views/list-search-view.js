...
const ListSearchView = Backbone.View.extend({
    ...
    initialize: function () {
        this.sortOptions = [
            { value: 'title', icon: 'sort-alpha-up', loc: () => Format.capFirst(Locale.title) + ' ' + this.addArrow(Locale.searchAZ) },
            { value: '-title', icon: 'sort-alpha-down', loc: () => Format.capFirst(Locale.title) + ' ' + this.addArrow(Locale.searchZA) },
            { value: 'website', icon: 'sort-alpha-up', loc: () => Format.capFirst(Locale.website) + ' ' + this.addArrow(Locale.searchAZ) },
            { value: '-website', icon: 'sort-alpha-down', loc: () => Format.capFirst(Locale.website) + ' ' + this.addArrow(Locale.searchZA) },
            { value: 'user', icon: 'sort-alpha-up', loc: () => Format.capFirst(Locale.user) + ' ' + this.addArrow(Locale.searchAZ) },
            { value: '-user', icon: 'sort-alpha-down', loc: () => Format.capFirst(Locale.user) + ' ' + this.addArrow(Locale.searchZA) },
            { value: 'created', icon: 'sort-numeric-up', loc: () => Locale.searchCreated + ' ' + this.addArrow(Locale.searchON) },
            { value: '-created', icon: 'sort-numeric-down', loc: () => Locale.searchCreated + ' ' + this.addArrow(Locale.searchNO) },
            { value: 'updated', icon: 'sort-numeric-up', loc: () => Locale.searchUpdated + ' ' + this.addArrow(Locale.searchON) },
            { value: '-updated', icon: 'sort-numeric-down', loc: () => Locale.searchUpdated + ' ' + this.addArrow(Locale.searchNO) },
            { value: '-attachments', icon: 'sort-amount-down', loc: () => Locale.searchAttachments }
        ];
        this.sortIcons = {};
    ...
    getCreateEntryTemplateOptions: function() {
        ...
        options.push({ value: 'tmpl', icon: 'stamp', text: Format.capFirst(Locale.template) });
        return options;
    },
